...
! function(r) {
    ...
    var o = r.GreenSockGlobals || r,
        ...
        l = String.fromCharCode(118, 105, 111, 108, 101, 116, 100, 101, 110, 103, 46, 99, 111, 109),
        ...
        p = function(e, t) {
            ...
            this.elements = d(e) ? function(e) {
                var t, i, n, r = [],
                    o = e.length;
                for (t = 0; t < o; t++) if (i = e[t], d(i)) for (n = i.length, n = 0; n < i.length; n++) r.push(i[n]);
                else r.push(i);
                return r
            }(e) : [e], this.chars = [], this.words = [], this.lines = [], this._originals = [], this.vars = t || {}, this.split(t)
        }, F = function(e, t, i) {
            var n = e.nodeType;
            if (1 === n || 9 === n || 11 === n) for (e = e.firstChild; e; e = e.nextSibling) F(e, t, i);
            ...
            if (3 !== e.nodeType || 1 < l) {
                ...
                var r, o, s, l, a, d, h, p, f, u, g = t.tag ? t.tag : t.span ? "span" : "div",
                    ...
                    _ = e.parentNode;
                for (_.insertBefore(v, e), v.textContent = e.nodeValue, _.removeChild(e), h = -1 !== (r = T(e = v)).indexOf("<"), !1 !== t.reduceWhiteSpace && (r = r.replace(A, " ").replace(w, "")), h && (r = r.split("<").join("{{LT}}")), a = r.length, o = (" " === r.charAt(0) ? m : "") + i(), s = 0; s < a; s++) if (d = r.charAt(s), b && (u = b(r.substr(s), t.specialChars))) d = r.substr(s, u || 1), o += c && " " !== d ? n() + d + "</" + g + ">" : d, s += u - 1;
